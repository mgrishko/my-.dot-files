...
alias sw='sass --watch app/assets/stylesheets:app/assets/stylesheets'
alias spec='time rspec --drb spec'
#alias cucew='cucumber --profile wip RAILS_ENV=cucumber'
#alias cuce='cucumber RAILS_ENV=cucumber'
